...
- **Release process**: Fixed automatic publishing to NuGet when creating new releases
- **Documentation**: Improved README layout and added visual banner

**Note**: This is a documentation and release process update. No changes to NuGone's functionality.
